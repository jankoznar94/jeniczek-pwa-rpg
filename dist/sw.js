...
const ASSET_FILES = [
  ...
  '/assets/items/helmet_crown.png', '/assets/items/armor_leather.png',
  ...
  '/assets/projectiles/shadow.png', '/assets/projectiles/nature.png',
  '/assets/projectiles/lightning.png', '/assets/projectiles/arcane.png',
  '/assets/projectiles/firebolt.png', '/assets/projectiles/fireblast.png',
  '/assets/projectiles/icebolt.png', '/assets/projectiles/blizzard.png',
  '/assets/projectiles/lightningBolt.png', '/assets/projectiles/chainLightning.png',
  '/assets/projectiles/thunderStorm.png',
